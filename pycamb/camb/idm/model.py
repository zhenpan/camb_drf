...
Transfer_kh = 1
Transfer_cdm = 2
Transfer_idm = 3       #ZP idm
Transfer_b = 4
Transfer_g = 5
Transfer_drf = 6       #ZP drf
Transfer_r = 7          #massless nu
Transfer_nu = 8          #massive nu
Transfer_tot = 9
Transfer_nonu = 10
Transfer_tot_de = 11
Transfer_Weyl = 12
Transfer_Newt_vel_cdm = 13
Transfer_Newt_vel_baryon = 14
Transfer_vel_baryon_cdm = 15
Transfer_vel_idm = 16           #ZP idm
Transfer_max = Transfer_vel_idm 
...
transfer_names = ['k/h', 'delta_cdm', 'delta_idm', 'delta_baryon', 'delta_photon', 'delta_drf', 'delta_neutrino', 'delta_massnu', 'delta_tot',
                  'delta_nonu', 'delta_tot_de', 'Weyl', 'v_newtonian_cdm', 'v_newtonian_baryon', 'v_baryon_cdm', 'v_idm_cdm']
...
grhog_drf = dll_import(c_double, "modelparams", "grhog_drf") #ZP drf
...
grhoc_idm = dll_import(c_double, "modelparams", "grhoc_idm") #ZP idm
...
class CAMBparams(CAMB_Structure):
    ...
    def set_cosmology(self, H0=67.0, cosmomc_theta=None, ombh2=0.022, omch2=0.12, omidmh2=0.0, omk=0.0, Num_drf=0.0,                   
                      ...
                      theta_H0_range=[10, 100]):                                                       #ZP idm and drf
        """
        ...
        self.omegac_idm = omidmh2 / fac #ZP idm
        ...
        self.omegav = 1 - omk - self.omegab - self.omegac - self.omegan -self.omegac_idm     #ZP idm
    ...
    def get_omega_k(self):
        ...
        :return: Omega_k
        """
        return 1 - self.omegab - self.omegac - self.omegac_idm- self.omegan - self.omegav     # ZP idm
